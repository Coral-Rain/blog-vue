    ...
    <div>
      ...
      <div class="ui relaxed divided items attached tab">
        <div class="item text-left" v-for="c in comments">
          <router-link :to="{name: 'PersonDefault', params: {userId: c.userId}}" target="_blank" class="ui avatar image" style="width: 35px">
          ...
          <div class="content">
            ...
            <div class="extra user-actions">
              <div class="ui left floated middle aligned pub-date-info">
                ...
                <router-link :to="{name: 'BlogDetail', params: {blogId: c.blogId}}" target="_blank">{{c.blogTitle}}</router-link>
              </div>
