  ...
  <div class="container write-blog">
    <div class="text-left">
      <ol v-if="blogId" class="breadcrumb breadcrumb-path">
        <li>
          <router-link :to="{name: 'PersonDefault'}">{{user.username}}的个人空间</router-link>
        </li>
        <li>
      ...
      <form action="#">
        <div class="form-group form-title">
          ...
          <div class="col-xs-4">
            ...
            <i class="glyphicon glyphicon-plus pointer pull-left" data-toggle="modal"
               data-target="#addBlogTypeModal"></i>
            ...
            <div class="dropdown text-left" style="margin-top: 25px">
              <button class="btn btn-default dropdown-toggle form-select" type="button" data-toggle="dropdown"
        ...
        <div class="form-tab">
          <ul class="nav nav-tabs">
            <li role="presentation" :class="markdown ? '' : 'active'" @click="markdown = false"><a href="#">HTML编辑器</a>
            </li>
            <li role="presentation" :class="markdown ? 'active' : ''" @click="markdown = true"><a href="#">Markdown</a>
            </li>
          </ul>
          <div class="field">
            <mavon-editor v-if="markdown" v-model="content" ref="md" @imgAdd="$imgAdd" @imgDel="$imgDel"
                          :toolbars="toolbars"/>
            <editor v-else id="tinymce" v-model="content" :init="options"></editor>
          </div>
        </div>
        ...
        <div v-if="!original" class="form-group form-inline text-left">
          ...
          <input v-model="reprintUrl" type="text" class="form-control" placeholder="请在此输入原文链接"
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <input id="blogTypeInput" v-model="newBlogType" placeholder="请输入分类名称..." class="form-control"
                       type="text">
              </div>
            </form>
          </div>
              ...
              POST({
                ...
                callback: res => {
                  if (res.code === 200) {
                    ...
                    that.markdown = res.data.draft.markdown
                  }
                }
              })
            }
